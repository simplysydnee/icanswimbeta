...
import { Users, CheckCircle, Calendar, AlertCircle, CalendarCheck } from "lucide-react";
import { useAdminKPIsQuery } from "@/hooks/useAdminKPIsQuery";
import { Skeleton } from "@/components/ui/skeleton";

export const AdminKPICards = () => {
  const { data: kpis, isLoading } = useAdminKPIsQuery();
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{kpis.activeSwimmers}</div>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{kpis.upcomingSessions}</div>
        </CardContent>
      </Card>
    </div>
  );
