  ...
  try {
    ...
    const transformedSwimmers: SwimmerResponse[] = (data as any[]).map(swimmer => {
      ...
      return {
        ...
        fundingSourceCurrentPosNumber: swimmer.current_authorization_number || undefined,
        fundingSourcePosExpiresAt: swimmer.authorization_expires_at || undefined,
        ...
        // Priority Booking
        isPriorityBooking: swimmer.is_priority_booking || false,
        priorityBookingReason: swimmer.priority_booking_reason || undefined,
        priorityBookingNotes: swimmer.priority_booking_notes || undefined,
        priorityBookingExpiresAt: swimmer.priority_booking_expires_at || undefined,
        // Admin Notes
        adminNotes: swimmer.admin_notes || undefined,
        importantNotes: swimmer.important_notes || undefined,
        // Coordinator fields — prefer funding_coordinator_* then fall back to coordinator_*
        coordinatorName: swimmer.funding_coordinator_name || swimmer.coordinator_name || undefined,
        coordinatorEmail: swimmer.funding_coordinator_email || swimmer.coordinator_email || undefined,
        coordinatorPhone: swimmer.funding_coordinator_phone || swimmer.coordinator_phone || undefined,
        // Authorization / PO details
        authorizedSessionsTotal: swimmer.authorized_sessions_total || 0,
        authorizedSessionsUsed: swimmer.authorized_sessions_used || 0,
        currentAuthorizationNumber: swimmer.current_authorization_number || undefined,
        authorizationExpiresAt: swimmer.authorization_expires_at || undefined,
        // Medical & Safety
