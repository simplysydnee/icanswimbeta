-- Add unexcused_late_cancel_count tracking to swimmers
-- Updated each time cancel_booking is called with p_late_cancel_type = 'unexcused'

ALTER TABLE swimmers ADD COLUMN IF NOT EXISTS unexcused_late_cancel_count integer NOT NULL DEFAULT 0;

-- ── Update cancel_booking to handle 'unexcused' late cancels ──────────
